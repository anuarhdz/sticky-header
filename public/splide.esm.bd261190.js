...
})({"b5Izv":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "1e874ec7bd261190";
...
function Media(Splide2, Components2, options) {
    ...
    function register(options2, query1) {
    ...
    function set(opts, user) {
        ...
        if (!state.is(CREATED)) Splide2.emit(EVENT_UPDATED, options);
    }
    return {
        setup: setup,
        destroy: destroy,
...
function Slides(Splide2, Components2, options) {
    ...
    function getIn(page) {
        var Controller1 = Components2.Controller;
        var index = Controller1.toIndex(page);
        var max1 = Controller1.hasFocus() ? 1 : options.perPage;
...
function Layout(Splide2, Components2, options) {
    ...
    var Slides1 = Components2.Slides;
    var resolve = Components2.Direction.resolve;
    var _Components2$Elements2 = Components2.Elements, root = _Components2$Elements2.root, track = _Components2$Elements2.track, list = _Components2$Elements2.list;
    var getAt = Slides1.getAt, styleSlides = Slides1.style;
    var vertical;
    var rootRect;
    function mount() {
        init();
    ...
    function getGap() {
        var Slide5 = getAt(0);
        return Slide5 && parseFloat(style(Slide5.slide, resolve("marginRight"))) || 0;
    }
...
function Clones(Splide2, Components2, options) {
    ...
    var Elements1 = Components2.Elements, Slides3 = Components2.Slides;
    var resolve = Components2.Direction.resolve;
    var clones = [];
    var cloneCount;
    function mount() {
    ...
    function generate(count) {
        ...
        if (length) {
            ...
            push(slides.slice(-count), slides.slice(0, count)).forEach(function(Slide6, index) {
                ...
                push(clones, clone);
                Slides3.register(clone, index - count + (isHead ? 0 : length), Slide6.index);
            });
        }
    }
    ...
    function computeCloneCount() {
        ...
        if (!Splide2.is(LOOP)) clones2 = 0;
            ...
            var fixedCount = fixedSize && ceil(rect(Elements1.track)[resolve("width")] / fixedSize);
...
function Move(Splide2, Components2, options) {
    ...
    function toIndex(position) {
        var Slides4 = Components2.Slides.get();
        var index = 0;
        var minDistance = Infinity;
        for(var i = 0; i < Slides4.length; i++){
            var slideIndex = Slides4[i].index;
...
function Controller(Splide2, Components2, options) {
    ...
    var Move1 = Components2.Move;
    var getPosition = Move1.getPosition, getLimit = Move1.getLimit, toPosition = Move1.toPosition;
    ...
    function scroll(destination, duration, snap, callback) {
        Components2.Scroll.scroll(destination, duration, snap, function() {
            setIndex(loop(Move1.toIndex(getPosition())));
            callback && callback();
        });
    }
    ...
    function computeDestIndex(dest, from, snapPage) {
        if (isEnough()) {
            ...
            if (dest < 0 || dest > end) {
                if (!perMove && (between(0, dest, from, true) || between(end, from, dest, true))) dest = toIndex(toPage(dest));
                else {
    ...
    function toDest(destination) {
        var closest1 = Move1.toIndex(destination);
        return isSlide ? clamp(closest1, 0, getEnd()) : closest1;
    }
...
function Autoplay(Splide2, Components2, options) {
    ...
    var Elements3 = Components2.Elements, _Components2$Elements4 = Components2.Elements, root = _Components2$Elements4.root, toggle = _Components2$Elements4.toggle;
    ...
    function mount() {
        if (autoplay) {
            listen();
            toggle && setAttribute(toggle, ARIA_CONTROLS, Elements3.track.id);
            stopped || play();
            update();
        }
    }
...
function Cover(Splide2, Components2, options) {
    ...
    function toggle(cover2, img, Slide9) {
...
function Drag(Splide2, Components2, options) {
    ...
    var state = Splide2.state;
    var Move3 = Components2.Move, Scroll1 = Components2.Scroll, Controller3 = Components2.Controller, track = Components2.Elements.track, reduce = Components2.Media.reduce;
    var _Components2$Directio2 = Components2.Direction, resolve = _Components2$Directio2.resolve, orient = _Components2$Directio2.orient;
    var getPosition = Move3.getPosition, exceededLimit = Move3.exceededLimit;
    var basePosition;
    var baseEvent;
    var prevBaseEvent;
    var isFree;
    ...
    function onPointerMove(e) {
        ...
        if (e.cancelable) {
            if (dragging) {
                Move3.translate(basePosition + constrain(diffCoord(e)));
    ...
    function move(e) {
        ...
        reduce(false);
        if (isFree) Controller3.scroll(destination, 0, options.snap);
        else if (Splide2.is(FADE)) Controller3.go(orient(sign(velocity)) < 0 ? rewind ? "<" : "-" : rewind ? ">" : "+");
        else if (Splide2.is(SLIDE) && exceeded && rewind) Controller3.go(exceededLimit(true) ? ">" : "<");
...
function Pagination(Splide2, Components2, options) {
    var event = EventInterface(Splide2);
    var on = event.on, emit = event.emit, bind = event.bind;
    var Slides5 = Components2.Slides, Elements4 = Components2.Elements, Controller4 = Components2.Controller;
    ...
    function mount() {
        ...
        if (options.pagination && Slides5.isEnough()) {
            on([
                EVENT_MOVE,
                EVENT_SCROLL,
                EVENT_SCROLLED
    ...
    function destroy() {
        if (list) {
            remove(Elements4.pagination ? slice(list.children) : list);
    ...
    function createPagination() {
        ...
        var max4 = hasFocus() ? length : ceil(length / perPage);
        list = Elements4.pagination || create("ul", classes.pagination, Elements4.track.parentElement);
        ...
        for(var i = 0; i < max4; i++){
            ...
            var controls = Slides5.getIn(i).map(function(Slide12) {
...
function Sync(Splide2, Components2, options) {
    ...
    function onClick(Slide13) {
        Splide2.go(Slide13.index);
    }
    function onKeydown(Slide14, e) {
...
function Slide(Splide2, Components2, options) {
    ...
    var Move4 = Components2.Move, Controller5 = Components2.Controller, Scroll2 = Components2.Scroll;
    ...
    function start(index, done) {
        var destination = Move4.toPosition(index, true);
        var position = Move4.getPosition();
    ...
    function getSpeed(index) {
        ...
        if (Splide2.is(SLIDE) && rewindSpeed) {
            var prev = Controller5.getIndex(true);
            var end = Controller5.getEnd();
...
var Style = /*#__PURE__*/ function() {
    function Style1(id, options) {
        this.styles = {};
        this.id = id;
        this.options = options;
    }
    var _proto2 = Style1.prototype;
...
var SplideRenderer = /*#__PURE__*/ function() {
    function SplideRenderer1(contents, options, config, defaults) {
        this.slides = [];
        this.options = {};
        this.breakpoints = [];
    ...
    SplideRenderer1.clean = function clean(splide) {
        var _EventInterface17 = EventInterface(splide), on = _EventInterface17.on;
    ...
    var _proto3 = SplideRenderer1.prototype;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["b5Izv"], null, "parcelRequire7fe7")

//# sourceMappingURL=splide.esm.bd261190.js.map
